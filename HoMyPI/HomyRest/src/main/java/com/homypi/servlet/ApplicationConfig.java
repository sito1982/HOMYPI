...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        System.out.println("HOMY-REST configuration starting: getClasses()");            
        ...
        resources.add(com.homypi.servlet.HomyJacksonJsonProvider.class);
        resources.add(com.homypi.services.HomyPiRestService.class);
        //==> we could also choose packages, see below getProperties()
        
        System.out.println("HOMY-REST configuration ended successfully.");
